                            ...
                            <div class="form-group row">                                
                                ...
                                <div class="col-sm-9">
                                    <InputText id="login" required="true" placeholder="Логин" style="width:100%" 
                                        ...
                                        v-model.trim="login" 
                                        :class="{'p-invalid': isSubmitting && !login}"
                                        @keyup.enter="loginClick"/>
                                        <small class="p-invalid" v-if="isSubmitting && !login">Укажите имя входа!</small>
                                </div>                              
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <Password id="password" required="true" placeholder="Пароль" style="width:100%" 
                                        ...
                                        :feedback="false" :class="{'p-invalid': isSubmitting && !password}"
                                        @keyup.enter="loginClick"/>
                                    <small v-if="isSubmitting && !password" class="p-invalid">Укажите пароль!</small>
                                </div>                               
                            </div>
...
export default Vue.extend({   
    ...
    head() {        
        return {
            //заголовок браузера
            title: 'Авторизация в системе | АРМ оператора ИС Верификатор'
        }
    },    
